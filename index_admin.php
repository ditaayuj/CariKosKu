...
<body>
    ...
    <div class="admin-section">
        ...
        <h2 class="section-title" style="margin: 0 0 20px;">Data Pengguna</h2>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="hapus_user.php?id=<?= $user['id'] ?>" onclick="return confirm('Yakin hapus user ini?')">
                                <button class="btn-report" style="padding:6px 14px; font-size:13px;">Hapus</button>
                            </a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
    ...
    <div class="admin-section">
        ...
        <h2 class="section-title" style="margin: 0 0 20px;">Data Kos</h2>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <a href="verifikasi_kos.php?id=<?= $kos['id'] ?>">
                                    <button class="btn-detail" style="padding:6px 14px; font-size:13px;">Verifikasi</button>
                                </a>
                            <?php endif; ?>
                        </td>
                        <td>
