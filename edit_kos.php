...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $query = "UPDATE kos SET nama_kos='$nama_kos', alamat='$alamat', kampus_terdekat='$kampus_terdekat', harga='$harga', gender='$gender', fasilitas='$fasilitas', jam_malam='$jam_malam', status='$status' WHERE id='$id' AND user_id='$user_id'";
        ...
        <div class="form-card">
            ...
            <form action="" method="POST">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="nama_kos" value="<?= $kos['nama_kos'] ?>" required>
                </div>

                <div class="input-group">
                    <label>Alamat Lengkap</label>
                    <input type="text" name="alamat" value="<?= $kos['alamat'] ?>" required>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="harga" value="<?= $kos['harga'] ?>" required>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="fasilitas" value="<?= $kos['fasilitas'] ?>" required>
                </div>
